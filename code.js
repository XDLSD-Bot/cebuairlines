...
const officerRoleE = "| Chief Executive Officer";
const welcomeMessage = "Welcome!";
const maxXP = 10;
const xpAuditLogChannelID = "669933698505768960";
const mainChatChannelID = "669933698505768960";
...
bot.on('message', async message => {
  ...
  if (message.content.toLowerCase().startsWith(`${prefix}commands`)){
    ...
    var second = new Discord.RichEmbed()
      ...
      .setDescription(`The following commands can be ran by: *Staff*.`)
